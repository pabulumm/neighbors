...
admin.site.register(models.TrashMarker)
admin.site.register(models.PoolMarker)
admin.site.register(models.SpaMarker)
admin.site.register(models.YardSaleMarker)
